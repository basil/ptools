...
impl FindElf {
    ...
    /// A callback that locates ELF images by build ID.
    ///
    /// Used with `Report::core_file` for core dump analysis.
    pub const BUILD_ID: FindElf = FindElf(crate::dw_sys::dwfl_build_id_find_elf);
}
